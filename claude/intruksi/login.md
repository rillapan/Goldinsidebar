...
```bash
npm install lucide-react @radix-ui/react-slot class-variance-authority @radix-ui/react-label @radix-ui/react-separator @radix-ui/react-checkbox clsx tailwind-merge
```
...
import { EyeIcon, EyeOffIcon, GithubIcon, MailIcon, LockIcon } from 'lucide-react'
...
Custom colors detected: gradient-to-br, muted-foreground, primary-foreground, accent-foreground, secondary-foreground, card-foreground
